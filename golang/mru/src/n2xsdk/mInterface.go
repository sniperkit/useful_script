...
func(np *mInterface) GetTimestampLocation ()(string, error) {
 //parameters: PortHandle
 //AgtAtmInterface GetTimestampLocation
 return "", nil
}
...
func(np *mInterface) GetMplsEncapsulation ()(string, error) {
 //parameters: PortHandle
 //AgtAtmInterface GetMplsEncapsulation
 return "", nil
}
...
func(np *mInterface) GetCellIgnoreMode ()(string, error) {
 //parameters: PortHandle
 //AgtAtmInterface GetCellIgnoreMode
 return "", nil
}
...
func(np *mInterface) GetNetworkInterface ()(string, error) {
 //parameters: PortHandle
 //AgtAtmInterface GetNetworkInterface
 return "", nil
}
...
func(np *mInterface) GetMTUSize ()(string, error) {
 //parameters: PortHandle
 //AgtAtmInterface GetMTUSize
 return "", nil
}
...
func(np *mInterface) GetFillerCellType ()(string, error) {
 //parameters: PortHandle
 //AgtAtmInterface GetFillerCellType
 return "", nil
}
