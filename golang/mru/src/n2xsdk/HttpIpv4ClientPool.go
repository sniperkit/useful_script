...
type HttpIpv4ClientPool struct {
 Handler string
}
...
func(np *HttpIpv4ClientPool) GetServerIpv4IncrementorValue ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetServerIpv4IncrementorValue
 return "", nil
}
...
func(np *HttpIpv4ClientPool) GetIpPriorityType ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetIpPriorityType
 return "", nil
}
...
func(np *HttpIpv4ClientPool) GetRawPriority ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetRawPriority
 return "", nil
}
...
func(np *HttpIpv4ClientPool) GetTosPrecedence ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetTosPrecedence
 return "", nil
}
...
func(np *HttpIpv4ClientPool) GetTosDelay ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetTosDelay
 return "", nil
}
...
func(np *HttpIpv4ClientPool) GetTosThroughput ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetTosThroughput
 return "", nil
}
...
func(np *HttpIpv4ClientPool) GetTosReliability ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetTosReliability
 return "", nil
}
...
func(np *HttpIpv4ClientPool) GetDiffServType ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetDiffServType
 return "", nil
}
...
func(np *HttpIpv4ClientPool) GetDiffServDefault ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetDiffServDefault
 return "", nil
}
...
func(np *HttpIpv4ClientPool) GetDiffServClassSelector ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetDiffServClassSelector
 return "", nil
}
...
func(np *HttpIpv4ClientPool) GetDiffServAssuredForwarding ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetDiffServAssuredForwarding
 return "", nil
}
...
func(np *HttpIpv4ClientPool) GetDiffServExpeditedForwarding ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetDiffServExpeditedForwarding
 return "", nil
}
...
func(np *HttpIpv4ClientPool) GetDiffServEcn ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetDiffServEcn
 return "", nil
}
...
func(np *HttpIpv4ClientPool) GetVersion ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetVersion
 return "", nil
}
...
func(np *HttpIpv4ClientPool) GetServerPortNumber ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetServerPortNumber
 return "", nil
}
...
func(np *HttpIpv4ClientPool) GetResponseWaitTimer ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetResponseWaitTimer
 return "", nil
}
...
func(np *HttpIpv4ClientPool) GetResumeWriteTimer ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetResumeWriteTimer
 return "", nil
}
...
func(np *HttpIpv4ClientPool) GetBytesPerWrite ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetBytesPerWrite
 return "", nil
}
...
func(np *HttpIpv4ClientPool) GetOperatingMode ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetOperatingMode
 return "", nil
}

func(np *HttpIpv4ClientPool) GetMaximumTcpConnections ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetMaximumTcpConnections
 return "", nil
}

func(np *HttpIpv4ClientPool) GetMaximumTcpConnectionsPerPool ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetMaximumTcpConnectionsPerPool
 return "", nil
}
...
func(np *HttpIpv4ClientPool) GetHttpRedirections ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetHttpRedirections
 return "", nil
}
...
func(np *HttpIpv4ClientPool) GetMaximumSegmentSize ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetMaximumSegmentSize
 return "", nil
}
...
func(np *HttpIpv4ClientPool) GetMaximumWindowSize ()(string, error) {
 //parameters: SessionPoolHandle
 //AgtHttpIpv4ClientPool GetMaximumWindowSize
 return "", nil
}
...
func(np *HttpIpv4ClientPool) SendGetRequest ()(string, error) {
 //parameters: SessionIdentifiers FileName StoreResponse
 //AgtHttpIpv4ClientPool SendGetRequest
 return "", nil
}
